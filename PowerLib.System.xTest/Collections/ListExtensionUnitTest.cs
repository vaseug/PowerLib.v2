...
public class ListExtensionUnitTest
{
  ...
  private static void AssertSorted(Array? originalArray, Array? actualArray, object range, object? comparer)
  {
    ...
    if (comparer != null)
      ...
      comparer = Reflector.GetProperty(typeof(Comparer<>).MakeGenericType(actualArray.GetType().GetElementType()!), nameof(Comparer<dynamic>.Default), MemberAccessibility.Public, null, null);
